...
const PaintingSelector: React.FC<PaintingSelectorProps> = ({ onSelect }) => {
  ...
  useEffect(() => {
    ...
    // Select painting on click of current card
    const handleCardClick = (e: MouseEvent) => {
        const target = e.target as HTMLElement;
        const currentCard = target.closest(".current--card");
        if (currentCard) {
            const paintingId = currentCard.getAttribute("data-painting-id");
            if (paintingId) {
                onSelect(paintingId);
            }
        }
      ...
      <div className="selector-app">
        <div className="cardList">
          ...
          <div className="cards__wrapper">
            <div className="card current--card" data-painting-id="demo_painting">
              <div className="card__image">
                <img src="/assets/贵妃晓妆.jpg" alt="贵妃晓妆" />
              </div>
            </div>

            <div className="card next--card" data-painting-id="demo_painting_2">
              <div className="card__image">
                <img src="/assets/高山流水.jpg" alt="高山流水" />
              </div>
            </div>

            <div className="card previous--card" data-painting-id="demo_painting_3">
              <div className="card__image">
